Generate and install the app icon for /tmp/caviar-tech-relay.
...
/tmp/caviar-tech-relay/app/src/main/res/drawable/icon.png
...
After saving icon.png, validate it with `bash /home/codex-agent/codex-app-agent/validate-icon.sh /tmp/caviar-tech-relay/app/src/main/res/drawable/icon.png`.
